...
async function notifyUpdate(): Promise<void> {
  try {
    ...
    if (res?.latest) {
      ...
      console.log();
      console.log(chalk.yellow.bold("A new version of `create-nextra-app` is available!"));
      console.log(
        "You can update by running: " +
          chalk.cyan(isYarn ? "yarn global add create-nextra-app" : "npm i -g create-nextra-app")
      );
      console.log();
    }
    process.exit();
